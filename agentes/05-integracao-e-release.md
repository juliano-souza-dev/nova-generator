...
- Manter compatibilidade de leitura com sugestões editoriais 1.0 sem unidades; pacotes 1.1 incluem
  palavras e `semantic_units`, sem incluir nem aceitar alterações de timing.
